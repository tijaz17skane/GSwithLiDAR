...
# this will output gpk and ply and txt files in world format for you view how images.txt look. So input images.txt and get a viewable file in whatever format you like
...
python Depth-Anything-V2/metric_depth/run.py --encoder vitl --pred-only --grayscale --img-path <path to input images> --outdir <output path> --load-from /mnt/data/tijaz/Depth-Anything-V2/checkpoints/depth_anything_v2_metric_vkitti_vitl.pth

...
def write_points3d(path, original_lines, bbox_points, start_id):
...
def main():
    ...
    parser.add_argument("--spacing", type=float, default=2.0, help="Spacing between bounding box points")
    args = parser.parse_args()

    # Read original file and points
    with open(args.input, 'r') as f:
        original_lines = f.readlines()
    points = read_points3d(args.input)
    ...
    write_points3d(args.output, original_lines, bbox_points, last_id+1)

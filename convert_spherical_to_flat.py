...
def parse_args():
    ...
    parser.add_argument('--fov', type=float, default=72.0, help='Field of view for flat images (degrees)')
    parser.add_argument('--skip_angles', type=str, default="lbf:216,288;lbb:216,288", help='Angles to skip for each camera, e.g. \"lbf:180,240,300;lbb:180,240,300\"')
    parser.add_argument('--flat_images_folder', type=str, default='/mnt/data/tijaz/datasets/section_3useful/flat_images', help='Output folder for flat images')
